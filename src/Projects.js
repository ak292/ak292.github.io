      ...
      <div className={styles["container-two"]}>
        ...
        <div className={styles["discord-bot"]}>
          ...
          <div id="first-div" onClick={handleClick} className={styles["hidden-more-info"]}>
            <p className={styles["para-hidden"]}>
              <i id={styles.dropicon} class={projectStates.firstProject ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right"}></i>Click for more info!
            </p>
        ...
        <div className={styles["discord-bot"]}>
          ...
          <div id="second-div" onClick={handleClick} className={styles["hidden-more-info"]}>
            <p className={styles["para-hidden"]}>
              ...
              <i id={styles.dropicon} class={projectStates.secondProject ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right"}></i>Click for more info!
            </p>
        ...
        <div className={styles["discord-bot"]}>
          ...
          <div id="third-div" onClick={handleClick} className={styles["hidden-more-info"]}>
            <p className={styles["para-hidden"]}>
              <i id={styles.dropicon} class={projectStates.thirdProject ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right"}></i>Click for more info!
            </p>
